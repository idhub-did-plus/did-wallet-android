 ...
 *
 * <p>You can also add items to MyTabLayout in your layout through the use of {@link TabItem}.
 ...
 * </pre>
 *
 * @attr ref android.support.design.R.styleable#MyTabLayout_tabPadding
 * @attr ref android.support.design.R.styleable#MyTabLayout_tabPaddingStart
 * @attr ref android.support.design.R.styleable#MyTabLayout_tabPaddingTop
 * @attr ref android.support.design.R.styleable#MyTabLayout_tabPaddingEnd
 * @attr ref android.support.design.R.styleable#MyTabLayout_tabPaddingBottom
 * @attr ref android.support.design.R.styleable#MyTabLayout_tabContentStart
 * @attr ref android.support.design.R.styleable#MyTabLayout_tabBackground
 * @attr ref android.support.design.R.styleable#MyTabLayout_tabMinWidth
 * @attr ref android.support.design.R.styleable#MyTabLayout_tabMaxWidth
 * @attr ref android.support.design.R.styleable#MyTabLayout_tabTextAppearance
...
public class TabLayout extends HorizontalScrollView {
    ...
    static final int DEFAULT_GAP_TEXT_ICON = 2; // dps
    ...
    public TabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mIndicatorWidth = a.getDimension(R.styleable.TabLayout_wallet_tabIndicatorWidth, -1);
        ...
        mTabStrip.setSelectedIndicatorHeight(
                a.getDimensionPixelSize(R.styleable.TabLayout_wallet_tabIndicatorHeight, 0));

        mTabStrip.setSelectedIndicatorColor(a.getColor(R.styleable.TabLayout_wallet_tabIndicatorColor, 0));

        mTabPaddingStart = mTabPaddingTop = mTabPaddingEnd = mTabPaddingBottom = a
                .getDimensionPixelSize(R.styleable.TabLayout_wallet_tabPadding, 0);
        mTabPaddingStart = a.getDimensionPixelSize(R.styleable.TabLayout_wallet_tabPaddingStart,
                mTabPaddingStart);
        mTabPaddingTop = a.getDimensionPixelSize(R.styleable.TabLayout_wallet_tabPaddingTop,
                mTabPaddingTop);
        mTabPaddingEnd = a.getDimensionPixelSize(R.styleable.TabLayout_wallet_tabPaddingEnd,
                mTabPaddingEnd);
        mTabPaddingBottom = a.getDimensionPixelSize(R.styleable.TabLayout_wallet_tabPaddingBottom,
                mTabPaddingBottom);

        mTabTextAppearance = a.getResourceId(R.styleable.TabLayout_wallet_tabTextAppearance,
        ...
        if (a.hasValue(R.styleable.TabLayout_wallet_tabTextColor)) {
            // If we have an explicit text color set, use it instead
            mTabTextColors = a.getColorStateList(R.styleable.TabLayout_wallet_tabTextColor);
        }

        if (a.hasValue(R.styleable.TabLayout_wallet_tabSelectedTextColor)) {
            // We have an explicit selected text color set, so we need to make merge it with the
            // current colors. This is exposed so that developers can use theme attributes to set
            // this (theme attrs in ColorStateLists are Lollipop+)
            final int selected = a.getColor(R.styleable.TabLayout_wallet_tabSelectedTextColor, 0);
            mTabTextColors = createColorStateList(mTabTextColors.getDefaultColor(), selected);
        }
        if (a.hasValue(R.styleable.TabLayout_wallet_tabTextSize)) {
            mTabTextSize = a.getDimensionPixelSize(R.styleable.TabLayout_wallet_tabTextSize, dpToPx(14));
        }
        mRequestedTabMinWidth = a.getDimensionPixelSize(R.styleable.TabLayout_wallet_tabMinWidth,
                INVALID_WIDTH);
        mRequestedTabMaxWidth = a.getDimensionPixelSize(R.styleable.TabLayout_wallet_tabMaxWidth,
                INVALID_WIDTH);
        mTabBackgroundResId = a.getResourceId(R.styleable.TabLayout_wallet_tabBackground, 0);
        mContentInsetStart = a.getDimensionPixelSize(R.styleable.TabLayout_wallet_tabContentStart, 0);
        mMode = a.getInt(R.styleable.TabLayout_wallet_tabMode, MODE_FIXED);
        mTabGravity = a.getInt(R.styleable.TabLayout_wallet_tabGravity, GRAVITY_FILL);
        a.recycle();
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        private void updateIndicatorPosition() {
            ...
            if (selectedTitle != null && selectedTitle.getWidth() > 0) {
                left = selectedTitle.getLeft() + (selectedTitle.getWidth() - (int) mIndicatorWidth) / 2;
                right = left + (int) mIndicatorWidth;
...
//                            (1.0f - mSelectionOffset) * right);
                    left = (int) (mSelectionOffset * (nextTitle.getLeft() + (nextTitle.getWidth() - mIndicatorWidth) / 2)
                            + (1.0f - mSelectionOffset) * left);
                    right = left + (int) mIndicatorWidth;
        ...
        void animateIndicatorToPosition(final int position, int duration) {
            ...
            final int targetLeft = targetView.getLeft() + (targetView.getWidth() - (int) mIndicatorWidth) / 2;
            final int targetRight = targetLeft + (int) mIndicatorWidth;
...
//            final int targetRight = targetView.getRight();
    ...
    public static class MyTabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final WeakReference<TabLayout> mMyTabLayoutRef;
        private int mPreviousScrollState;
        private int mScrollState;

        public MyTabLayoutOnPageChangeListener(TabLayout TabLayout) {
            mMyTabLayoutRef = new WeakReference<>(TabLayout);
        }
        ...
        public void onPageScrolled(final int position, final float positionOffset,
            ...
            final TabLayout TabLayout = mMyTabLayoutRef.get();
            if (TabLayout != null) {
