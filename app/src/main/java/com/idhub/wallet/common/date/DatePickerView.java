package com.idhub.wallet.common.date;
...
public class DatePickerView extends View {
    ...
    private void init() {
        ...
        mPaint.setColor(ContextCompat.getColor(context, R.color.wallet_main_yellow_color));
        //第二个paint
        nPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        nPaint.setStyle(Style.FILL);
        nPaint.setTextAlign(Align.CENTER);
        nPaint.setColor(ContextCompat.getColor(context, R.color.wallet_black));
    }
    ...
    private void drawOtherText(Canvas canvas, int position, int type) {
        ...
        float scale = parabola(mViewHeight / 2f, d);
        float size = (mMaxTextSize - mMinTextSize) * scale + mMinTextSize;
