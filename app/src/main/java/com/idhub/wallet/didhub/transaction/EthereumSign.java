...
public class EthereumSign {
  ...
  public static String personalSign(String data, String prvKeyBytes) {
    ...
    return signMessage(dataToSign,  NumericUtil.hexToBytes(prvKeyBytes)).toString();
  }

  public static String sign(String data, String prvKeyBytes) {
    return signMessage(dataToBytes(data),  NumericUtil.hexToBytes(prvKeyBytes)).toString();
  }
