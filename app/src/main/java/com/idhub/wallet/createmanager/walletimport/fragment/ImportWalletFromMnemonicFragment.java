...
public class ImportWalletFromMnemonicFragment extends Fragment implements View.OnClickListener {
    ...
    private void submit() {
        ...
        if (mPasswordView.verifyPassword()) {
            ...
            checkWalletFromMnemonic(key, new DisposableObserver<TemplateAddress>() {
                @Override
                ...
                public void onNext(TemplateAddress templateAddress) {
                    ...
                    switch (templateAddress.type) {
                        ...
                        case IMPORT:
                            ...
                            importWallet(wallet, key, password, templateAddress.type);
                            break;
    ...
    private void importWallet(Wallet wallet, String key, String password, String msg) {
    ...
    private void checkWalletFromMnemonic(String key, DisposableObserver<TemplateAddress> disposableObserver) {
        Observable.create((ObservableOnSubscribe<TemplateAddress>) emitter -> {
            ...
            if (wallet != null) {
                ...
                if (!hasIdentity) {
                    Log.e("LYW", "checkWalletFromMnemonic:1 ");
                    //导入一个没有注册身份的钱包
                    emitter.onNext(new TemplateAddress(IMPORT, address));
                } else {
                    Log.e("LYW", "checkWalletFromMnemonic:2 ");
                    //已经注册身份
