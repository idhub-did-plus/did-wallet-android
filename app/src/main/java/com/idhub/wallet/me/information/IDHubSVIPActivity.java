...
public class IDHubSVIPActivity extends BaseActivity implements View.OnClickListener, InputDialogFragment.InputDialogFragmentListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.wallet_activity_idhub_svip);
    ...
    public static void startAction(Context context) {
        Intent intent = new Intent(context, IDHubSVIPActivity.class);
