...
public class BaseInformationLayout extends InformationItemLayout {

    private InformationKeyValueLayout firstNameView;
    private InformationKeyValueLayout middleNameView;
    private InformationKeyValueLayout lastNameView;
    private InformationKeyValueLayout birthdayView;
    private InformationKeyValueLayout emailView;
    private InformationKeyValueLayout nationalityView;
    ...
    protected void init() {
        ...
        birthdayView.setClickListener(new OnClickListener() {
            @Override
        ...
        nationalityView.setClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        phoneView.setHint(context.getString(R.string.wallet_please_input) + " " + context.getString(R.string.wallet_phone_number));
        phoneCodeView = findViewById(R.id.tv_phone_dialing_code);
        phoneCodeView.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                selectDialingCode();
            }
        ...
        saveBtnView.setOnClickListener(saveBtnClickListener);
    }
    ...
    private void selectCountry(InformationKeyValueLayout informationKeyValueLayout) {
        CountryPickerDialog countryPicker =
                new CountryPickerDialog(getContext(), new CountryPickerCallbacks() {
                    @Override
                    public void onCountrySelected(Country country) {
                        if (informationKeyValueLayout == nationalityView) {
                        ...
                        } else if (informationKeyValueLayout == countryView) {
