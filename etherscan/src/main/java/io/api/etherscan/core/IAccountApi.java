...
public interface IAccountApi {
     ...
     * @throws ApiException parent exception class
     */
    @NotNull List<Tx> txs(String address, long startBlock, long endBlock,String page,int offset,String sort) throws ApiException;
    @NotNull List<Tx> txs(String address, long startBlock, long endBlock,String page,int offset) throws ApiException;
     ...
     * @throws ApiException parent exception class
     */
    @NotNull List<TxToken> txsToken(String address, long startBlock, long endBlock,String page,int offset,String sort) throws ApiException;
